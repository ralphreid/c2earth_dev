...
describe "stakeholder_companies/new" do
  before(:each) do
    assign(:stakeholder_company, stub_model(StakeholderCompany,
  ...
  it "renders new stakeholder_company form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", stakeholder_companies_path, "post" do
